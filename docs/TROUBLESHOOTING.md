# 🔧 Troubleshooting Guide — Query Regeneration Fallback
...
2. **Check official documentation:**
   - [GitHub Issues for this repo](https://github.com/Pradeeptalari14/tp-query-regeneration-fallback/issues)
   - [Studio FAQ](https://pradeeptalari14.github.io/portfolio/tools/query-regeneration-fallback/)
